#include <Arduino.h>
#line 1 "d:\\Arduino\\Arduino\\remote_control_on_arduino\\remote_control_on_arduino.ino"
#include <SPI.h>
#include <nRF24L01.h>
#include <RF24.h>
#include <Servo.h>
...
#line 16 "d:\\Arduino\\Arduino\\remote_control_on_arduino\\remote_control_on_arduino.ino"
void setup();
#line 58 "d:\\Arduino\\Arduino\\remote_control_on_arduino\\remote_control_on_arduino.ino"
void loop();
#line 16 "d:\\Arduino\\Arduino\\remote_control_on_arduino\\remote_control_on_arduino.ino"
void setup() 
{
  ...
  pinMode(2, OUTPUT);
  pinMode(3, OUTPUT);//ШИМ с A2 передатчика
  pinMode(4, OUTPUT);
  pinMode(5, OUTPUT);//ШИМ с A3 передатчика
  pinMode(6, OUTPUT);//ШИМ с A4 передатчика
  pinMode(7, OUTPUT);//пьезодинамик
  pinMode(8, OUTPUT);//пьезодинамик
  
  pinMode(14, OUTPUT);//пин A0//сервомотор1
  pinMode(15, OUTPUT);//пин A1//сервомотор2
  pinMode(16, OUTPUT);//пин A2//с кнопки на пине 3 передатчика
  pinMode(17, OUTPUT);//пин A3//с кнопки на пине 5 передатчика
  pinMode(18, OUTPUT);//пин A4//с кнопки на пине 6 передатчика
  pinMode(19, OUTPUT);//пин A5
  pinMode(20, OUTPUT);//пин A6
  pinMode(21, OUTPUT);//пин A7
